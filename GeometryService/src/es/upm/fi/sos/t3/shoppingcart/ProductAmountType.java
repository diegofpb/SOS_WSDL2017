 ...
 */
        ...
        /* This type was generated from the piece of schema that had
                name = productAmountType
                Namespace URI = http://shoppingCart.t3.sos.fi.upm.es
                  ...
                  if (serializeType){
                   ...
                   if ((namespacePrefix != null) && (namespacePrefix.trim().length() > 0)){
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           namespacePrefix+":productAmountType",
                           xmlWriter);
                   } else {
                       writeAttribute("xsi","http://www.w3.org/2001/XMLSchema-instance","type",
                           "productAmountType",
    ...
    public static class Factory{
        ...
        */
        public static ProductAmountType parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ProductAmountType object =
                new ProductAmountType();
            ...
            try {
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"productAmountType".equals(type)){
                                ...
                                return (ProductAmountType)es.upm.fi.sos.t3.shoppingcart.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                ...
                java.util.Vector handledAttributes = new java.util.Vector();
                    ...
                    reader.next();
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://shoppingCart.t3.sos.fi.upm.es","product").equals(reader.getName())){
                                    ...
                                    if (reader.isStartElement() && new javax.xml.namespace.QName("http://shoppingCart.t3.sos.fi.upm.es","amount").equals(reader.getName())){
