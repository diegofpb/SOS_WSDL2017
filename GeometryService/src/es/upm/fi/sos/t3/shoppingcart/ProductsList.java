 ...
 */
    ...
    public static class Factory{
        ...
        */
        public static ProductsList parse(javax.xml.stream.XMLStreamReader reader) throws java.lang.Exception{
            ProductsList object =
                new ProductsList();
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"productsList".equals(type)){
                                ...
                                return (ProductsList)es.upm.fi.sos.t3.shoppingcart.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
                                    ...
                                    list1.add(reader.getElementText());
                                            ...
                                            while(!loopDone1){
                                                ...
                                                if (reader.isEndElement()){
                                                    ...
                                                    if (new javax.xml.namespace.QName("http://shoppingCart.t3.sos.fi.upm.es","product").equals(reader.getName())){
                                                         list1.add(reader.getElementText());
