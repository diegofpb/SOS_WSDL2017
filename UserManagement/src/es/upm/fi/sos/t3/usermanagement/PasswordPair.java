...
public class PasswordPair implements org.apache.axis2.databinding.ADBBean {
	...
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://usermanagement.t3.sos.fi.upm.es", "passwordPair", "ns1");
	...
	public void serialize(final javax.xml.namespace.QName parentQName,
		...
		namespace = "http://usermanagement.t3.sos.fi.upm.es";
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		elementList.add(new javax.xml.namespace.QName(
				"http://usermanagement.t3.sos.fi.upm.es", "oldpwd"));
		...
		elementList.add(new javax.xml.namespace.QName(
				"http://usermanagement.t3.sos.fi.upm.es", "newpwd"));
			...
			try {
						...
						if (!"passwordPair".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (PasswordPair) es.upm.fi.sos.t3.usermanagement.ExtensionMapper
				...
				if (reader.isStartElement()
					...
					if ("true".equals(nillableValue)
						...
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "oldpwd" + "  cannot be null");
					}
				...
				if (reader.isStartElement()
					...
					if ("true".equals(nillableValue)
							|| "1".equals(nillableValue)) {
						throw new org.apache.axis2.databinding.ADBException(
								"The element: " + "newpwd" + "  cannot be null");
					}
