		...
		try {
			...
			if ((op.getName() != null)
				...
				if ("login".equals(methodName)) {
					...
					es.upm.fi.sos.t3.usermanagement.User wrappedParam = (es.upm.fi.sos.t3.usermanagement.User) fromOM(
					...
					envelope = toEnvelope(getSOAPFactory(msgContext),
							response6, false, new javax.xml.namespace.QName(
				...
				if ("addUser".equals(methodName)) {
					...
					envelope = toEnvelope(getSOAPFactory(msgContext),
							response8, false, new javax.xml.namespace.QName(
									"http://usermanagement.t3.sos.fi.upm.es",
									"addUser"));
				} else
				...
				if ("changePassword".equals(methodName)) {
					...
					es.upm.fi.sos.t3.usermanagement.PasswordPair wrappedParam = (es.upm.fi.sos.t3.usermanagement.PasswordPair) fromOM(
							msgContext.getEnvelope().getBody()
									.getFirstElement(),
					...
					envelope = toEnvelope(getSOAPFactory(msgContext),
							response10, false, new javax.xml.namespace.QName(
									"http://usermanagement.t3.sos.fi.upm.es",
									"changePassword"));
				} else
				...
				if ("removeUser".equals(methodName)) {
					...
					es.upm.fi.sos.t3.usermanagement.Username wrappedParam = (es.upm.fi.sos.t3.usermanagement.Username) fromOM(
							msgContext.getEnvelope().getBody()
									.getFirstElement(),
					...
					envelope = toEnvelope(getSOAPFactory(msgContext),
							response12, false, new javax.xml.namespace.QName(
									"http://usermanagement.t3.sos.fi.upm.es",
									"removeUser"));
