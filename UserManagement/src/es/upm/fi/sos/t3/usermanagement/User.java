...
public class User implements org.apache.axis2.databinding.ADBBean {
	...
	public static final javax.xml.namespace.QName MY_QNAME = new javax.xml.namespace.QName(
			"http://usermanagement.t3.sos.fi.upm.es", "user", "ns1");
	...
	public javax.xml.stream.XMLStreamReader getPullParser(
		...
		elementList.add(new javax.xml.namespace.QName(
				"http://usermanagement.t3.sos.fi.upm.es", "name"));
		...
		elementList.add(new javax.xml.namespace.QName(
				"http://usermanagement.t3.sos.fi.upm.es", "pwd"));
						...
						if (!"user".equals(type)) {
							...
							java.lang.String nsUri = reader
									.getNamespaceContext().getNamespaceURI(
											nsPrefix);
							return (User) es.upm.fi.sos.t3.usermanagement.ExtensionMapper
